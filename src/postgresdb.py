...
class Database:
    ...
    def maak_database(self):
        ...
        self.cursor.execute(Openbareruimte.drop(self.config.schema))
        self.cursor.execute(Pand.drop(self.config.schema))
        self.cursor.execute(Standplaats.drop(self.config.schema))
        self.cursor.execute(Verblijfsobject.drop(self.config.schema))
        self.cursor.execute(Woonplaats.drop(self.config.schema))
        self.cursor.execute(Verblijfsobjectgebruiksdoel.drop(self.config.schema))
        self.cursor.execute(Verblijfsobjectpand.drop(self.config.schema))
        self.cursor.execute(Adresseerbaarobjectnevenadres.drop(self.config.schema))
        self.cursor.execute(Gemeentewoonplaats.drop(self.config.schema))
        self.cursor.execute(Gemeenteprovincie.drop(self.config.schema))
        
        self.cursor.execute(Ligplaats.create(self.config.schema))
        self.cursor.execute(Nummeraanduiding.create(self.config.schema))
        self.cursor.execute(Openbareruimte.create(self.config.schema))
        self.cursor.execute(Pand.create(self.config.schema))
        self.cursor.execute(Standplaats.create(self.config.schema))
        self.cursor.execute(Verblijfsobject.create(self.config.schema))
        self.cursor.execute(Woonplaats.create(self.config.schema))
        self.cursor.execute(Verblijfsobjectgebruiksdoel.create(self.config.schema))
        self.cursor.execute(Verblijfsobjectpand.create(self.config.schema))
        self.cursor.execute(Adresseerbaarobjectnevenadres.create(self.config.schema))
        self.cursor.execute(Gemeentewoonplaats.create(self.config.schema))
        self.cursor.execute(Gemeenteprovincie.create(self.config.schema))
